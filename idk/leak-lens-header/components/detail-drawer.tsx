...
import { Subscription, LeakScoreBreakdown } from '@/lib/types'
import { mockLeakScore } from '@/lib/mock-data'
...
export function DetailDrawer({ subscription, onClose }: DetailDrawerProps) {
  ...
  const leakScore = mockLeakScore
  const recoverable = subscription.monthlyAmount * 12 * 0.75
        ...
        <div className="p-8">
          ...
          <div className="mb-8 border border-ink p-4">
            ...
            <ol className="space-y-3 font-mono text-sm text-ink">
              <li>
                <span className="font-bold">1. Verify</span> — Check if you still use
                this service
              </li>
              <li>
                <span className="font-bold">2. Cancel</span> — Visit merchant website
                or call customer service
              </li>
              <li>
                <span className="font-bold">3. Confirm</span> — Ask for refund of
                recent charges if applicable
              </li>
            </ol>
